...
internal object ConfigurationDataDecoder: StateDecoder {
    override fun decode(bb: ByteBuffer): RobotState = ConfigurationData(
        jointConfigurationData = (0..5).map { jointIndex ->
            ConfigurationData.JointConfigurationData(
                ...
                jointMaxLimit = bb.getDouble(jointIndex * 16 + 8),             // loop 1 -> offset = jointIndex * 16 bytes (2x double) + 8 bytes (1x double)
